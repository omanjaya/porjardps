  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div className="space-y-2">
        <Skeleton className="h-8 w-40 bg-esi-border" />
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1.5">
                <Skeleton className="h-8 w-16 bg-esi-border" />
      ...
      <div>
        <Skeleton className="mb-4 h-6 w-40 bg-esi-border" />
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 2 }).map((_, i) => (
            <Skeleton key={i} className="h-44 rounded-xl bg-esi-border" />
          ))}
        </div>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-esi-border bg-white dark:bg-zinc-900 p-5 shadow-sm">
          <Skeleton className="mb-4 h-6 w-36 bg-esi-border" />
          <div className="space-y-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex gap-3">
                <Skeleton className="mt-2 h-2 w-2 shrink-0 rounded-full bg-esi-border" />
                <div className="flex-1 space-y-1.5">
                  <Skeleton className="h-4 w-3/4 bg-esi-border" />
                  <Skeleton className="h-3 w-20 bg-esi-border" />
                </div>
              </div>
            ))}
          </div>
