...
export function SpectatorCount({ matchId }: SpectatorCountProps) {
  ...
  return (
    <div
      className="inline-flex items-center gap-1.5 rounded-full bg-white/80 dark:bg-zinc-900/80 border border-stone-200 dark:border-zinc-700 px-3 py-1 text-sm text-stone-700 dark:text-zinc-300"
      aria-live="polite"
      aria-atomic="true"
    >
