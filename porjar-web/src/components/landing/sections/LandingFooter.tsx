...
export function LandingFooter({ events, contacts }: Props) {
  ...
  return (
    <footer className="footer-section border-t border-stone-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="footer-col anim-fade">
            <h4 className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-stone-400 dark:text-zinc-500">Kompetisi</h4>
          ...
          <div className="footer-col anim-fade">
            <h4 className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-stone-400 dark:text-zinc-500">Informasi</h4>
            <div className="flex flex-col gap-2 text-sm text-stone-500 dark:text-zinc-400">
          ...
          <div className="footer-col anim-fade">
            <h4 className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-stone-400 dark:text-zinc-500">Komunitas</h4>
            <div className="flex flex-col gap-2 text-sm text-stone-500 dark:text-zinc-400">
          ...
          <div className="footer-col anim-fade">
            <h4 className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-stone-400 dark:text-zinc-500">Event</h4>
            <div className="flex flex-col gap-2 text-sm text-stone-500 dark:text-zinc-400">
          ...
          <div className="footer-col anim-fade sm:col-span-2 lg:col-span-5 border-t border-stone-200 dark:border-zinc-800 pt-6">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-stone-600 dark:text-zinc-400">
              {contactList.map((c) => (
                <div key={c.name}>
          ...
          <div className="footer-col anim-fade sm:col-span-2 lg:col-span-5 border-t border-stone-200 dark:border-zinc-800 pt-6 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <a href="https://instagram.com/esi.denpasar" target="_blank" rel="noopener noreferrer" aria-label="Instagram ESI Denpasar" className="flex h-9 w-9 items-center justify-center rounded-lg border border-stone-200 dark:border-zinc-700 text-stone-400 dark:text-zinc-500 transition hover:border-red-200 hover:text-esi-red">
                <InstagramLogo size={16} />
              </a>
              <a href="mailto:info@esidenpasar.com" aria-label="Email ESI Denpasar" className="flex h-9 w-9 items-center justify-center rounded-lg border border-stone-200 dark:border-zinc-700 text-stone-400 dark:text-zinc-500 transition hover:border-red-200 hover:text-esi-red">
                <EnvelopeSimple size={16} />
              </a>
              <a href="https://esidenpasar.com" aria-label="Website ESI Denpasar" className="flex h-9 w-9 items-center justify-center rounded-lg border border-stone-200 dark:border-zinc-700 text-stone-400 dark:text-zinc-500 transition hover:border-red-200 hover:text-esi-red">
                <Globe size={16} />
              </a>
            </div>
          </div>
